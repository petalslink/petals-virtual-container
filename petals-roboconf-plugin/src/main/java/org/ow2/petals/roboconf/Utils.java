        ...
        try {
            ...
            try {
                ...
                throw new PluginException(String.format(
                        ...
                        propertiesFile.getAbsolutePath(), componentName), e);
            } finally {
                try {
                    fos.close();
                } catch (IOException e) {
                    logger.log(Level.WARNING, "An error occurs closing the properties file", e);
                }
            }
        } catch (final FileNotFoundException e) {
            throw new PluginException(String.format(
                    "The properties file '%s' of component '%s' can not be created or updated.",
                    propertiesFile.getAbsolutePath(), componentName), e);
        }
    }
