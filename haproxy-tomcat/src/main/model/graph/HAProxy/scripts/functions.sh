...
#   - Tomcat8_size: Tomcat8 instance number,
#   - Tomcat8_x_ip: IP address of the Tomcat8 instance "x",
#   - Tomcat8_x_port: listening port of the Tomcat8 instance "x".
#
# Returns:
...
do
   ...
   remote_port_var_name="Tomcat8_${i}_port"
   eval remote_port=\$${remote_port_var_name}
   
   remote_ip_var_name="Tomcat8_${i}_ip"
